...
function atualizarContagem(){
    ...
    let dias = Math.floor(segundosTotais / 86400).toString().padStart(2,'0')
    ...
    document.getElementById("relogioId").textContent = (`${dias} Dias: ${horas} Horas:  ${minutos} Minutos:  ${segundos} Segundos `);
